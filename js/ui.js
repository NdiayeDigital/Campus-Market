...
// ==========================================
// SPA NAVIGATION LOGIC (EXPOSÉE IMMÉDIATEMENT)
// ==========================================
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    window.filterProducts = function () {
        ...
        dynamicProductCards.forEach(card => {
            ...
            if (desc.includes('tech') || title.includes('casque'))
                cardCategory = 'tech';
            if (desc.includes('bijoux') || title.includes('collier'))
                cardCategory = 'jewelry';
            if (desc.includes('librairie') || title.includes('cahier'))
                cardCategory = 'school';
            if (desc.includes('couture') || title.includes('blouse'))
